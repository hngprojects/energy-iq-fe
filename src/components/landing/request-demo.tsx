...
export const RequestDemo = () => {
  ...
  return (
    <Section className="bg-white py-24">
      <Container>
        <div className="relative isolate flex min-h-[600px] flex-col justify-between overflow-hidden rounded-[8px] p-6 md:p-11">
          {/* Background Image */}
          <Image
            src={demo_bg}
          ...
          <div className="no-scrollbar relative z-10 flex snap-x gap-4 overflow-x-auto pb-4 md:grid md:grid-cols-3 md:overflow-x-visible md:pb-0">
            {badges.map((badge, index) => (
              <div key={index} className="w-[92%] flex-shrink-0 snap-center md:w-full">
                <DemoBadge
                  title={badge.title}
