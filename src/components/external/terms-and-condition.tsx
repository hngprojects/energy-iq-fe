    ...
    <div className="bg-background selection:bg-amber-10 min-h-screen font-sans text-slate-100 selection:text-amber-800">
      ...
      <header className="bg-secondary relative h-[300px] w-full overflow-hidden md:h-[400px]">
        ...
        <div className="relative z-20 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          >
            Welcome to EnergyIQ, an AI-powered energy monitoring and management platform.
            By using EnergyIQ, you agree to the following Terms & Conditions.
          </motion.p>
        </div>
      </header>
            ...
            <div className="w-full space-y-20 lg:w-3/4 lg:pl-8">
              ...
              <section id="acceptance" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 leading-relaxed md:text-lg">
                    <p>
                      By accessing or using EnergyIQ, you confirm that you have read,
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-4 leading-relaxed md:text-lg">
                    ...
                    <p>
                      ...
                      – The business, household, or solar company using EnergyIQ.
                    </p>
                    <p>
                      <span className="font-semibold text-slate-100">
                        &apos;Users&apos;
                      </span>{" "}
                      – Admins, Owners, and Members authorized by the organization.
                    </p>
                  </div>
                </motion.div>
              </section>
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-8 leading-relaxed md:text-lg">
                    <div className="">
                      ...
                      <p>
                        User accounts are created by the account owner. Additional members
                        may be invited and managed by the account owner.
                      </p>
                    </div>
                    <div>
                      <h3 className="mb-3 text-lg font-bold text-slate-100">
                      ...
                      <p>
                        Users must provide accurate details. The account owner is
                        responsible for maintaining correct user data.
                      </p>
                    </div>
                    <div>
                      <h3 className="mb-3 text-lg font-bold text-slate-100">Security</h3>
                      <p>
                        Users are responsible for keeping their login credentials secure.
                        EnergyIQ is not liable for unauthorized access resulting from weak
                        or shared passwords.
                      </p>
                    </div>
                  </div>
              ...
              <section id="platform-usage" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-6 leading-relaxed md:text-lg">
                    <p>
                      Users agree to use EnergyIQ only for legitimate energy monitoring
                      and management activities. Users must NOT:
                    </p>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div className="space-y-4">
                      <h3 className="text-lg font-bold text-slate-100">Data Ownership</h3>
                      <p className="text-slate-80">
                        All energy, system, and usage data belongs solely to the account
                        owner.
                      </p>
                    </div>
                    <div className="space-y-4">
                      <h3 className="text-lg font-bold text-slate-100">Data Usage</h3>
                      <p className="text-slate-80">
                        EnergyIQ only processes data for the purpose of enabling the
                        platform&apos;s features (energy monitoring, savings calculations,
                        alerts, AI insights, reports, etc.).
                      </p>
                    </div>
                    <div className="col-span-full space-y-4">
                      ...
                      <p className="text-slate-80">
                        The platform uses encrypted connections, secure login, and
                        activity logs to help protect your data.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              <section id="reports" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 leading-relaxed md:text-lg">
                    <p className="mb-4">
                      EnergyIQ displays energy data sourced from connected inverter
                      systems or user-entered readings. Savings estimates and carbon
                      offset figures are calculated based on standard formulas and
                      user-provided inputs.
                    </p>
                    <div className="">
                      <p className="text-secondary mb-4">
                        These are estimates and should not be treated as audited financial
                        records.
                      </p>
                      <p className="text-secondary">
                        Users must not manipulate energy records outside approved
                        workflows.
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="text-md text-slate-80 leading-relaxed md:text-lg">
                    <p className="mb-6 text-balance">
                      EnergyIQ sends alerts and notifications to users via WhatsApp and
                      in-app notifications. It is the user&apos;s responsibility to ensure
                      their contact details and WhatsApp number are correct and up to
                      date.
                    </p>
                    <p className="text-balance">
                      EnergyIQ is not responsible for undelivered messages caused by
                      incorrect user-provided information or external service issues.
                    </p>
                  </div>
                </motion.div>
              </section>
              ...
              <section id="availability" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-6 leading-relaxed md:text-lg">
                    <p>
                      EnergyIQ aims to provide reliable access; however, availability may
                      be affected by:
                    </p>
                    ...
                    <p className="font-semibold text-slate-100">
                      The platform will make reasonable efforts to restore access
                      promptly.
                    </p>
                  </div>
                </motion.div>
              ...
              <section id="intellectual-property" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 leading-relaxed md:text-lg">
                    <p className="mb-4">
                      All software, designs, content, and features of EnergyIQ are the
                      property of the platform provider.
                    </p>
                    <p className="">
                      Users may not copy, resell, distribute, or reverse-engineer any part
                      of the system.
                    </p>
                  </div>
                </motion.div>
              ...
              <section id="suspension" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-6 leading-relaxed md:text-lg">
                    <p className="text-balance">EnergyIQ may suspend access if:</p>
              ...
              <section id="liability" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 space-y-6 leading-relaxed md:text-lg">
                    <p className="text-balance">
                      EnergyIQ is provided &apos;as-is.&apos; The platform is not
                      responsible for:
                    </p>
              ...
              <section id="changes" className="scroll-mt-32">
                ...
                >
                  ...
                  <div className="text-md text-slate-80 leading-relaxed md:text-lg">
                    <p>
                      We may update these Terms & Conditions. The revised version will be
                      effective once posted or communicated to users. Continued use of
                      EnergyIQ indicates acceptance of the updated terms.
                    </p>
                  </div>
                </motion.div>
              </section>
                ...
                >
                  ...
                  <div className="">
                    <p className="text-md mb-6 font-medium opacity-90 md:text-lg">
                      For support or concerns regarding EnergyIQ, please contact your
                      designated platform representative or support channel.
                    </p>
                  </div>
                </motion.div>
              </section>
