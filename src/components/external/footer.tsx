        ...
        <div className="mt-12 grid w-full grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5">
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-base text-[#E6E6E6]">
              <li className="cursor-pointer hover:text-[#F5A623]">Features</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Pricing</li>
              <li className="cursor-pointer hover:text-[#F5A623]">API Integrations</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Contact</li>
            </ul>
          </div>
          <div className="space-y-6">
            <h3 className="text-lg font-bold">Company</h3>
            <ul className="space-y-3 text-base text-[#E6E6E6]">
              <li className="cursor-pointer hover:text-[#F5A623]">About</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Blog</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Career</li>
              <li className="cursor-pointer hover:text-[#F5A623]">News</li>
            </ul>
          </div>
          <div className="space-y-6">
            <h3 className="text-lg font-bold">Resources</h3>
            <ul className="space-y-3 text-base text-[#E6E6E6]">
              <li className="cursor-pointer hover:text-[#F5A623]">Use Cases</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Community</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Help Centre</li>
            </ul>
          </div>
          <div className="space-y-6">
            <h3 className="text-lg font-bold">Download</h3>
            <ul className="space-y-3 text-base text-[#E6E6E6]">
              <li className="cursor-pointer hover:text-[#F5A623]">iOS</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Android</li>
              <li className="cursor-pointer hover:text-[#F5A623]">Windows</li>
            </ul>
          </div>
          <div className="col-span-1 space-y-6 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              ...
              />
              <button className="w-full rounded-xl bg-[#F5A623] px-6 py-3 font-bold text-[#1A1F2C] transition-colors hover:bg-[#E59513]">
                Subscribe
              </button>
            </div>
          </div>
